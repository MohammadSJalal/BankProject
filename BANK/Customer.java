...
public class Customer extends Person { private static int customerCounter = 0; private String customerId; private List<Account> accounts; private List<String> inboxMessages; private List<BaseLoan> loans; private Bank bank;
...
public boolean hasActiveLoan() {
    return !loans.isEmpty(); // در صورت نیاز به بررسی دقیق‌تر، وضعیت بازپرداخت هم لحاظ شود
}
